...
" Plugins {
    ...
    " Markdown {
        ...
        let g:vim_markdown_fenced_languages = ['coffee', 'css', 'bash=sh', 'erb=eruby', 'javascript', 'js=javascript', 'json=javascript', 'ruby', 'sass', 'xml', 'html']
    " }
